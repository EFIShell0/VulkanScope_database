...
asset=root/'assets/app.v03925.js'
...
if './assets/app.v03925.js' not in index or './config.js?v=03925' not in index: errors.append('0.39.22 cache-busted frontend references missing')
...
if errors:raise SystemExit('FAIL Database 0.39.25 contract\n- '+'\n- '.join(errors))
print('PASS Database 0.39.25 retained loading/scroll/floor/device-type contract')
