...
mutations=[
 ...
 ('index.html','app.v1003.js?v=1003','app.v1003.js','cache-bust'),
 ('assets/app.v1003.js','notice encyclopedia-evidence-note','encyclopedia-evidence-note','shared-notice-language'),
 ('assets/app.v1003.js','entries.length>=24','entries.length>=240','result-bound'),
]
