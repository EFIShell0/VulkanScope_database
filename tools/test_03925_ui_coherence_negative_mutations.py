...
mutations=[
 ...
 ('index.html','app.v1007.js?v=1007','app.v1007.js','cache-bust'),
 ('assets/app.v1007.js','notice encyclopedia-evidence-note','encyclopedia-evidence-note','shared-notice-language'),
 ('assets/app.v1007.js','entries.length>=24','entries.length>=240','result-bound'),
]
