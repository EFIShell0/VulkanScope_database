...
mutations=[
 ...
 ('index.html','app.v1008.js?v=1008','app.v1008.js','cache-bust'),
 ('assets/app.v1008.js','notice encyclopedia-evidence-note','encyclopedia-evidence-note','shared-notice-language'),
 ('assets/app.v1008.js','entries.length>=24','entries.length>=240','result-bound'),
]
