...
mutations=[
 ...
 ('index.html','app.v1006.js?v=1006','app.v1006.js','cache-bust'),
 ('assets/app.v1006.js','notice encyclopedia-evidence-note','encyclopedia-evidence-note','shared-notice-language'),
 ('assets/app.v1006.js','entries.length>=24','entries.length>=240','result-bound'),
]
