...
USER_AGENT = 'VulkanScope-Database-preload/1.2.0'
...
def main():
    ...
    manifest = {
        ...
        'compatibleProducer': meta.get('compatibleProducer', 'VulkanScope 1.2.5+ · schema 2 / technical report 3'),
