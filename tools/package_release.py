...
contract_path = root/'regression/1.0.7_to_1.0.8_contract.json'
...
zip_path = out_dir / 'VulkanScope-Database-1.0.8.zip'
...
with tempfile.TemporaryDirectory(prefix='vulkanscope-db-release-1.0.8-') as td:
