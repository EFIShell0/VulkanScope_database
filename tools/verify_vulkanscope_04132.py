...
w=(root/'worker/src/index.js').read_text(encoding='utf-8'); schema=json.loads((root/'report.schema.json').read_text(encoding='utf-8')); app=(root/'assets/app.v1400.js').read_text(encoding='utf-8'); errors=[]
def check(v,m):
