...
app_path=root/'assets/app.v03924.js'; enc_path=root/'assets/encyclopedia.v03924.js'
...
if './assets/encyclopedia.v03924.js' not in index or './assets/app.v03924.js' not in index: errors.append('0.39.24 Encyclopedia/app assets are not loaded')
...
if errors: raise SystemExit('FAIL Database 0.39.24 floor/Encyclopedia contract\n- '+'\n- '.join(errors))
print('PASS Database 0.39.24 floor/Encyclopedia contract')
