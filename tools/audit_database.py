...
AUDIT_VERSION='1.0.22'
DB_VERSION='1.0.22'
APP_ASSET='app.v1022.js'
CACHE_KEY='1022'
...
def audit_source(root:Path):
    ...
    need(worker.count("databaseReleaseVersion:'1.0.22'")>=3,'Worker databaseReleaseVersion mismatch')
    need(worker.count("workerReleaseVersion:'1.0.22'")>=3,'Worker workerReleaseVersion mismatch')
    ...
    # Requested 1.0.22 foreground live-sync behavior and preserved evidence semantics.
