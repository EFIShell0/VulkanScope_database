...
CURRENT_APP = 'app.v1407.js'
CURRENT_BROWSER_COMPAT = 'browser-compat.v1407.js'
CURRENT_RELEASE_BOOTSTRAP = 'release-bootstrap.v1407.js'
PREDECESSOR_BRIDGE = {'app.v1406.js','browser-compat.v1406.js','release-bootstrap.v1406.js'}
...
if errors:
    print('\n'.join(errors))
    sys.exit(1)
print(f'VulkanScope Database 1.4.7 repository state: PASS')
