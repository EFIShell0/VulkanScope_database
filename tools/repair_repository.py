...
CURRENT_APP = 'app.v1310.js'
CURRENT_BROWSER_COMPAT = 'browser-compat.v1310.js'
CURRENT_RELEASE_BOOTSTRAP = 'release-bootstrap.v1310.js'
PREDECESSOR_BRIDGE = {'app.v1309.js','browser-compat.v1309.js','release-bootstrap.v1309.js'}
...
if errors:
    print('\n'.join(errors))
    sys.exit(1)
print(f'VulkanScope Database 1.3.10 repository state: PASS')
