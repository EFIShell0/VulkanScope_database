...
CURRENT_APP = 'app.v1307.js'
CURRENT_BROWSER_COMPAT = 'browser-compat.v1307.js'
CURRENT_RELEASE_BOOTSTRAP = 'release-bootstrap.v1307.js'
PREDECESSOR_BRIDGE = {'app.v1306.js','browser-compat.v1306.js','release-bootstrap.v1306.js'}
...
if errors:
    print('\n'.join(errors))
    sys.exit(1)
print(f'VulkanScope Database 1.3.7 repository state: PASS')
