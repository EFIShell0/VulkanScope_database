...
CURRENT_APP = 'app.v1405.js'
CURRENT_BROWSER_COMPAT = 'browser-compat.v1405.js'
CURRENT_RELEASE_BOOTSTRAP = 'release-bootstrap.v1405.js'
PREDECESSOR_BRIDGE = {'app.v1404.js','browser-compat.v1404.js','release-bootstrap.v1404.js'}
...
if errors:
    print('\n'.join(errors))
    sys.exit(1)
print(f'VulkanScope Database 1.4.5 repository state: PASS')
