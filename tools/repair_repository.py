...
CURRENT_APP = 'app.v1309.js'
CURRENT_BROWSER_COMPAT = 'browser-compat.v1309.js'
CURRENT_RELEASE_BOOTSTRAP = 'release-bootstrap.v1309.js'
PREDECESSOR_BRIDGE = {'app.v1308.js','browser-compat.v1308.js','release-bootstrap.v1308.js'}
...
if errors:
    print('\n'.join(errors))
    sys.exit(1)
print(f'VulkanScope Database 1.3.9 repository state: PASS')
