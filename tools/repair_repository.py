...
CURRENT_APP = 'app.v1406.js'
CURRENT_BROWSER_COMPAT = 'browser-compat.v1406.js'
CURRENT_RELEASE_BOOTSTRAP = 'release-bootstrap.v1406.js'
PREDECESSOR_BRIDGE = {'app.v1405.js','browser-compat.v1405.js','release-bootstrap.v1405.js'}
...
if errors:
    print('\n'.join(errors))
    sys.exit(1)
print(f'VulkanScope Database 1.4.6 repository state: PASS')
