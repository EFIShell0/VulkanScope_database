...
if not args.skip_version: need(package.get('version')=='0.39.24','Database version is not 0.39.24')
...
index=text('index.html'); need('Database <strong>0.39.24</strong>' in index and 'encyclopedia.v03924.js' in index and 'app.v03924.js' in index,'index asset/version identity not 0.39.24')
...
if errors:
    print('FAIL Database 0.39.24 / Vulkan 1.4.362 contract')
    for e in errors:print('-',e)
    raise SystemExit(1)
print('PASS Database 0.39.24 / Vulkan 1.4.362 contract: producer=0.80.10 floor=0.80.3 symbols=842/6248/2461 extensions=476')
