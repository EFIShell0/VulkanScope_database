...
need(package.get('version')=='1.0.4','Database/Worker version is not 1.0.4')
need('VulkanScope Database <strong>1.0.4</strong>' in index and 'app.v1004.js?v=1004' in index,'1.0.4 browser identity/cache-bust missing')
need('Database 1.0.4 · schema' in app,'1.0.4 frontend release identity missing')
...
if errors:
    print('FAIL Database 1.0.4 retained registry-baseline producer-string contract')
    for e in errors: print('-',e)
    raise SystemExit(1)
print('PASS Database 1.0.4 retained exact registry-baseline strings: 0.80.3-0.80.9=Vulkan 1.4.361; 0.80.10+=Vulkan 1.4.362')
