...
('assets/app.v03924.js',"['encyclopedia','Encyclopedia']","['encyclopediaRemoved','Encyclopedia']",'encyclopedia-route'),
('assets/app.v03924.js','Registry/reference presence is not runtime capability evidence.','Registry reference proves runtime capability.','evidence-separation'),
...
print('PASS Database 0.39.24 floor/Encyclopedia negative mutations and false-positive control')
