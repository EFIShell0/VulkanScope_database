...
('assets/app.v03925.js',"['encyclopedia','Encyclopedia']","['encyclopediaRemoved','Encyclopedia']",'encyclopedia-route'),
('assets/app.v03925.js','Registry/reference presence is not runtime capability evidence.','Registry reference proves runtime capability.','evidence-separation'),
