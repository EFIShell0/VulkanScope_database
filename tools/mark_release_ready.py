...
expected={'schemaVersion':2,'databaseVersion':'1.2.11','releaseReady':False,'appAsset':'assets/app.v1211.js','cacheKey':'1211'}
...
print(f'Marked staged VulkanScope Database 1.2.11 artifact release-ready: {marker}')
