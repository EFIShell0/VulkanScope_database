...
expected={'schemaVersion':2,'databaseVersion':'1.2.3','releaseReady':False,'appAsset':'assets/app.v1203.js','cacheKey':'1203'}
...
print(f'Marked staged VulkanScope Database 1.2.3 artifact release-ready: {marker}')
