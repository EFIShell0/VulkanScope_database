...
expected={'schemaVersion':2,'databaseVersion':'1.3.3','releaseReady':False,'appAsset':'assets/app.v1303.js','cacheKey':'1303'}
...
print(f'Marked staged VulkanScope Database 1.3.3 artifact release-ready: {marker}')
