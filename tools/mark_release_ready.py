...
expected={'schemaVersion':2,'databaseVersion':'1.3.2','releaseReady':False,'appAsset':'assets/app.v1302.js','cacheKey':'1302'}
...
print(f'Marked staged VulkanScope Database 1.3.2 artifact release-ready: {marker}')
