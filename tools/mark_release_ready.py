...
expected={'schemaVersion':2,'databaseVersion':'1.0.25','releaseReady':False,'appAsset':'assets/app.v1025.js','cacheKey':'1025'}
...
print(f'Marked staged VulkanScope Database 1.0.25 artifact release-ready: {marker}')
