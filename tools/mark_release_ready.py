...
expected={'schemaVersion':2,'databaseVersion':'1.3.1','releaseReady':False,'appAsset':'assets/app.v1301.js','cacheKey':'1301'}
...
print(f'Marked staged VulkanScope Database 1.3.1 artifact release-ready: {marker}')
