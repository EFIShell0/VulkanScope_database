...
expected={'schemaVersion':2,'databaseVersion':'1.2.1','releaseReady':False,'appAsset':'assets/app.v1201.js','cacheKey':'1201'}
...
print(f'Marked staged VulkanScope Database 1.2.1 artifact release-ready: {marker}')
