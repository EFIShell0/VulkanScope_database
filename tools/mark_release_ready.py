...
expected={'schemaVersion':2,'databaseVersion':'1.4.1','releaseReady':False,'appAsset':'assets/app.v1401.js','cacheKey':'1401'}
...
print(f'Marked staged VulkanScope Database 1.4.1 artifact release-ready: {marker}')
