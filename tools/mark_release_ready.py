...
expected={'schemaVersion':2,'databaseVersion':'1.4.3','releaseReady':False,'appAsset':'assets/app.v1403.js','cacheKey':'1403'}
...
print(f'Marked staged VulkanScope Database 1.4.3 artifact release-ready: {marker}')
