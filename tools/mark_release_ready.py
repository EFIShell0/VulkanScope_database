...
expected={'schemaVersion':2,'databaseVersion':'1.2.2','releaseReady':False,'appAsset':'assets/app.v1202.js','cacheKey':'1202'}
...
print(f'Marked staged VulkanScope Database 1.2.2 artifact release-ready: {marker}')
