...
expected={'schemaVersion':2,'databaseVersion':'1.4.0','releaseReady':False,'appAsset':'assets/app.v1400.js','cacheKey':'1400'}
...
print(f'Marked staged VulkanScope Database 1.4.0 artifact release-ready: {marker}')
