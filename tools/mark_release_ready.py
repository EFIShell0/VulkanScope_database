...
expected={'schemaVersion':2,'databaseVersion':'1.3.6','releaseReady':False,'appAsset':'assets/app.v1306.js','cacheKey':'1306'}
...
print(f'Marked staged VulkanScope Database 1.3.6 artifact release-ready: {marker}')
