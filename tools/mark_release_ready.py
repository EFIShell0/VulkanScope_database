...
expected={'schemaVersion':2,'databaseVersion':'1.2.6','releaseReady':False,'appAsset':'assets/app.v1206.js','cacheKey':'1206'}
...
print(f'Marked staged VulkanScope Database 1.2.6 artifact release-ready: {marker}')
