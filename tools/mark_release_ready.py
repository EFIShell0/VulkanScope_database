...
expected={'schemaVersion':2,'databaseVersion':'1.3.9','releaseReady':False,'appAsset':'assets/app.v1309.js','cacheKey':'1309'}
...
print(f'Marked staged VulkanScope Database 1.3.9 artifact release-ready: {marker}')
