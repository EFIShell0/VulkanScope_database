...
expected={'schemaVersion':2,'databaseVersion':'1.2.4','releaseReady':False,'appAsset':'assets/app.v1204.js','cacheKey':'1204'}
...
print(f'Marked staged VulkanScope Database 1.2.4 artifact release-ready: {marker}')
