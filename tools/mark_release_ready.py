...
expected={'schemaVersion':2,'databaseVersion':'1.0.22','releaseReady':False,'appAsset':'assets/app.v1022.js','cacheKey':'1022'}
...
print(f'Marked staged VulkanScope Database 1.0.22 artifact release-ready: {marker}')
