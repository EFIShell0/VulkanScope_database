...
expected={'schemaVersion':2,'databaseVersion':'1.4.4','releaseReady':False,'appAsset':'assets/app.v1404.js','cacheKey':'1404'}
...
print(f'Marked staged VulkanScope Database 1.4.4 artifact release-ready: {marker}')
