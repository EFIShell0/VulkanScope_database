...
expected={'schemaVersion':2,'databaseVersion':'1.4.7','releaseReady':False,'appAsset':'assets/app.v1407.js','cacheKey':'1407'}
...
print(f'Marked staged VulkanScope Database 1.4.7 artifact release-ready: {marker}')
