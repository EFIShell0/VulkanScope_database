...
expected={'schemaVersion':2,'databaseVersion':'1.4.2','releaseReady':False,'appAsset':'assets/app.v1402.js','cacheKey':'1402'}
...
print(f'Marked staged VulkanScope Database 1.4.2 artifact release-ready: {marker}')
