...
expected={'schemaVersion':2,'databaseVersion':'1.2.0','releaseReady':False,'appAsset':'assets/app.v1200.js','cacheKey':'1200'}
...
print(f'Marked staged VulkanScope Database 1.2.0 artifact release-ready: {marker}')
