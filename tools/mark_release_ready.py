...
expected={'schemaVersion':2,'databaseVersion':'1.4.6','releaseReady':False,'appAsset':'assets/app.v1406.js','cacheKey':'1406'}
...
print(f'Marked staged VulkanScope Database 1.4.6 artifact release-ready: {marker}')
