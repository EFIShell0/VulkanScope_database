...
expected={'schemaVersion':2,'databaseVersion':'1.0.24','releaseReady':False,'appAsset':'assets/app.v1024.js','cacheKey':'1024'}
...
print(f'Marked staged VulkanScope Database 1.0.24 artifact release-ready: {marker}')
