...
expected={'schemaVersion':2,'databaseVersion':'1.3.0','releaseReady':False,'appAsset':'assets/app.v1300.js','cacheKey':'1300'}
...
print(f'Marked staged VulkanScope Database 1.3.0 artifact release-ready: {marker}')
