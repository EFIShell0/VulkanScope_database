...
expected={'schemaVersion':2,'databaseVersion':'1.4.5','releaseReady':False,'appAsset':'assets/app.v1405.js','cacheKey':'1405'}
...
print(f'Marked staged VulkanScope Database 1.4.5 artifact release-ready: {marker}')
