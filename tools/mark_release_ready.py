...
expected={'schemaVersion':2,'databaseVersion':'1.2.10','releaseReady':False,'appAsset':'assets/app.v1210.js','cacheKey':'1210'}
...
print(f'Marked staged VulkanScope Database 1.2.10 artifact release-ready: {marker}')
