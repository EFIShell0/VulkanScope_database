...
expected={'schemaVersion':2,'databaseVersion':'1.2.5','releaseReady':False,'appAsset':'assets/app.v1205.js','cacheKey':'1205'}
...
print(f'Marked staged VulkanScope Database 1.2.5 artifact release-ready: {marker}')
