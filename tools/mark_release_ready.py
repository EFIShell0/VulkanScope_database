...
expected={'schemaVersion':2,'databaseVersion':'1.3.7','releaseReady':False,'appAsset':'assets/app.v1307.js','cacheKey':'1307'}
...
print(f'Marked staged VulkanScope Database 1.3.7 artifact release-ready: {marker}')
