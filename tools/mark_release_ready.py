...
expected={'schemaVersion':2,'databaseVersion':'1.3.10','releaseReady':False,'appAsset':'assets/app.v1310.js','cacheKey':'1310'}
...
print(f'Marked staged VulkanScope Database 1.3.10 artifact release-ready: {marker}')
