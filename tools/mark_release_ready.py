...
expected={'schemaVersion':2,'databaseVersion':'1.0.23','releaseReady':False,'appAsset':'assets/app.v1023.js','cacheKey':'1023'}
...
print(f'Marked staged VulkanScope Database 1.0.23 artifact release-ready: {marker}')
