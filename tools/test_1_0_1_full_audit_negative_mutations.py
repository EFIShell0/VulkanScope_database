...
mutations=[
 ...
 ('assets/app.v1008.js',"const av=surfaceAvailableState(s),pr=surfacePresentationState(s),diag=","const av=s.available?'available':'unavailable',pr=s.presentationSupported?'supported':'unsupported',diag=",'frontend-bool-state'),
]
def run(tree):
