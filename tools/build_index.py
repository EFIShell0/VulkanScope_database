...
idx={"schemaVersion":1,"databaseVersion":"1.4.5","normalizerVersion":16,"publishedVulkanSpec":"Vulkan 1.4.362 (2026-09-04)","vulkanRegistryBaseline":"VulkanScope producer/query baseline 1.4.362","producerQueryBaseline":"VulkanScope 1.4.0 · Vulkan 1.4.362","compatibleProducer":"VulkanScope 1.4.0+ · schema 2 / technical report 3","generatedAt":datetime.datetime.now(datetime.timezone.utc).isoformat(),"reports":reports}
