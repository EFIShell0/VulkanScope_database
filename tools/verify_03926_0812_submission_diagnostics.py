...
a=(root/"assets/app.v1007.js").read_text(encoding="utf-8")
e=[]
def need(c,m):
    if not c:e.append(m)
need("VulkanScope 1.0.15 · Vulkan 1.4.362" in w and "VulkanScope 1.0.15 · Vulkan 1.4.362" in a,"current 1.0.0 producer baseline metadata missing")
...
if e: raise SystemExit("FAIL Database 1.0.0 0.80.12 submission diagnostics\n- "+"\n- ".join(e))
print("PASS Database 1.0.0 VulkanScope 0.80.12 submission diagnostics")
