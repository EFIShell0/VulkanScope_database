...
a=(root/"assets/app.v03927.js").read_text(encoding="utf-8")
e=[]
def need(c,m):
    if not c:e.append(m)
...
if e: raise SystemExit("FAIL Database 0.39.27 0.80.12 submission diagnostics\n- "+"\n- ".join(e))
print("PASS Database 0.39.27 VulkanScope 0.80.12 submission diagnostics")
