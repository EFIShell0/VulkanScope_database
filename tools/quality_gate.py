...
if (root/'regression/0.39.19_to_0.39.20_contract.json').exists(): run(sys.executable,'tools/verify_regression_contract.py')
...
run('node','--check','assets/app.v03920.js')
...
run('node','tools/test_producer_baseline_04145.mjs')
run('node','tools/test_producer_baseline_04145_negative_mutations.mjs')
