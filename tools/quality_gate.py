...
run(sys.executable,'tools/verify_1_4_1_address_privacy_filter_startup.py')
run(sys.executable,'tools/test_1_4_1_address_privacy_filter_startup_negative_mutations.py')
run(sys.executable,'tools/audit_database.py','--source-tree','.')
run('node','--check','assets/app.v1401.js')
run('node','--check','assets/browser-compat.v1401.js')
...
print('VulkanScope Database 1.4.1 quality gate: PASS')
