...
run(sys.executable,'tools/verify_1_4_2_startup_layout_address_ui.py')
run(sys.executable,'tools/test_1_4_2_startup_layout_address_ui_negative_mutations.py')
run(sys.executable,'tools/audit_database.py','--source-tree','.')
run('node','--check','assets/app.v1402.js')
run('node','--check','assets/browser-compat.v1402.js')
...
print('VulkanScope Database 1.4.2 quality gate: PASS')
