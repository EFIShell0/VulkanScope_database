...
assert.equal(j.databaseReleaseVersion,'1.4.6');
assert.equal(j.workerReleaseVersion,'1.4.6');
...
console.log('PASS Worker 1.4.6 transport contract: live sync head + VulkanScope 1.4.3 producer floor + historical reads + transport/security basics');
