...
assert.equal(j.databaseReleaseVersion,'1.2.11');
assert.equal(j.workerReleaseVersion,'1.2.11');
...
console.log('PASS Worker 1.2.11 transport contract: live sync head + VulkanScope 1.2.5 producer floor + historical reads + transport/security basics');
