...
assert.equal(j.databaseReleaseVersion,'1.2.7');
assert.equal(j.workerReleaseVersion,'1.2.7');
...
console.log('PASS Worker 1.2.7 transport contract: live sync head + VulkanScope 1.2.5 producer floor + historical reads + transport/security basics');
