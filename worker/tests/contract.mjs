...
assert.equal(j.databaseReleaseVersion,'1.4.5');
assert.equal(j.workerReleaseVersion,'1.4.5');
...
console.log('PASS Worker 1.4.5 transport contract: live sync head + VulkanScope 1.4.0 producer floor + historical reads + transport/security basics');
