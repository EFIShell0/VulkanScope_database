...
assert.equal(j.databaseReleaseVersion,'1.0.24');
assert.equal(j.workerReleaseVersion,'1.0.24');
...
console.log('PASS Worker 1.0.24 transport contract: live sync head + VulkanScope 1.0.19 producer floor + historical reads + transport/security basics');
