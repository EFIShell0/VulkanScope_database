...
assert.equal(j.databaseReleaseVersion,'1.4.0');
assert.equal(j.workerReleaseVersion,'1.4.0');
...
console.log('PASS Worker 1.4.0 transport contract: live sync head + VulkanScope 1.4.0 producer floor + historical reads + transport/security basics');
