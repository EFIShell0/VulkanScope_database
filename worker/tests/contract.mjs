...
assert.equal(j.databaseReleaseVersion,'1.0.25');
assert.equal(j.workerReleaseVersion,'1.0.25');
...
console.log('PASS Worker 1.0.25 transport contract: live sync head + VulkanScope 1.0.19 producer floor + historical reads + transport/security basics');
