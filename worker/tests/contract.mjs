...
assert.equal(j.databaseReleaseVersion,'1.4.3');
assert.equal(j.workerReleaseVersion,'1.4.3');
...
console.log('PASS Worker 1.4.3 transport contract: live sync head + VulkanScope 1.4.0 producer floor + historical reads + transport/security basics');
