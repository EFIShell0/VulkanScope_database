...
assert.equal(j.databaseReleaseVersion,'1.3.0');
assert.equal(j.workerReleaseVersion,'1.3.0');
...
console.log('PASS Worker 1.3.0 transport contract: live sync head + VulkanScope 1.2.5 producer floor + historical reads + transport/security basics');
