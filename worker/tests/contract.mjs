...
let current0810=fixture();current0810.application.version='0.80.10';current0810.application.versionCode=810;current0810.vulkan.registryBaseline='1.4.362';current0810.vulkan.headerBaseline='Vulkan 1.4.362 compile headers; validated query catalog Vulkan 1.4.362';current0810.technicalReport.registryCoverage.baseline='1.4.362';current0810.technicalReport.registryCoverage.headerBaseline=current0810.vulkan.headerBaseline;current0810.reportText=reportText(current0810);r=await call('/v1/reports',{method:'POST',body:current0810});assert.equal(r.status,201,'VulkanScope 0.80.10 / Vulkan 1.4.362 must be accepted');
...
let current0810OldRegistry=structuredClone(current0810);current0810OldRegistry.vulkan.registryBaseline='1.4.361';current0810OldRegistry.vulkan.headerBaseline='Vulkan 1.4.361 compile headers; validated query catalog Vulkan 1.4.361';current0810OldRegistry.technicalReport.registryCoverage.baseline='1.4.361';current0810OldRegistry.technicalReport.registryCoverage.headerBaseline=current0810OldRegistry.vulkan.headerBaseline;current0810OldRegistry.reportText=reportText(current0810OldRegistry);r=await call('/v1/reports',{method:'POST',body:current0810OldRegistry});assert.equal(r.status,400,'VulkanScope 0.80.10 must not claim the older Vulkan 1.4.361 collector baseline');
