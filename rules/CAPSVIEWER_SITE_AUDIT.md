...
The active `site.v0333.css` assigns these colors consistently to badges, state counts and percentage bars. Unavailable never uses the Supported green path.
